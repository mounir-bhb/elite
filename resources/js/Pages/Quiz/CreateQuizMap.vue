                ...
                <div v-for="(question, index) in form.questions" class="relative shadow-md p-6">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="flex gap-2  my-4 ">
                            <div v-for="(c, index) in form.questions[index].countries" class="flex gap-2 p-2 rounded-xl w-fit bg-slate-200 text-xs">
                                <div>{{ c }}</div>
                                <div @click="delCountry(index)" class="cursor-pointer">x</div>
                            </div>
                        </div>
                    </div>
                </div>
...
{"name": "Zimbabwe","code": "ZN"}
    ...
    methods: {
        ...
        addCountry(i){
            if(!this.form.questions[i].countries.includes(this.country))
                this.form.questions[i].countries.push(this.country)
        },
        delCountry(index, i){
            this.form.questions[index].countries.splice(i,1)
